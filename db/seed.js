...
//How the fullstack did it 
// // grab our client with destructuring from the export in index.js 
// const { client, getAllUsers, createUser, updateUser } = require('./index');

//  // this function should call a query which
// //      drops all tables from our database
...
//     } catch ( error ) {
//         throw error; 
//     // we pass the error up to the function that calls createTables   
//     }
// }
...
//             });
//             console.log("updatedUser:", updatedUser)
//         console.log('Finished databas tests')
//         //for now, logging is a fine way to check work 
//         // console.log( users );
//     } catch( error ){
//         console.error( error );
//     } /* finally {
